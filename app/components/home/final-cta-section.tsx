    ...
    <section className="border-t border-border bg-gradient-to-r from-primary to-primary/80 text-primary-foreground px-4 lg:py-24 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <div className="relative rounded-full p-1 mx-auto sm:mx-0.5">
            <Button
              size="lg"
          ...
          <div className="relative rounded-full py-1 -mx-2">
            <Button
              size="lg"
              variant="outline"
              className="rounded-full text-primary-foreground border-2 border-primary-foreground hover:bg-primary-foreground hover:text-primary bg-transparent font-semibold backdrop-blur-sm"
              asChild
            >
              <a
                href="https://github.com/haseeb-iqbal"
